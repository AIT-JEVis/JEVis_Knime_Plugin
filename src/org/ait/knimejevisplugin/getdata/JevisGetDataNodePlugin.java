 ...
 * @author Monschiebl
 */
public class JevisGetDataNodePlugin extends Plugin {
    // The shared instance.
    private static JevisGetDataNodePlugin plugin;

    /**
     * The constructor.
     */
    public JevisGetDataNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static JevisGetDataNodePlugin getDefault() {
        return plugin;
    }
